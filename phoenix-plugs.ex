# module plugs will take the conn and return the conn
# module plugs must have both an init func and call

# function plugs are better when you expect to only use it in one module
