...
const newObjConstruc = function() {}
newObjConstruc.prototype.protoPropHi = 'protoo hi'
const newCloneObj = new newObjConstruc()
console.log(Object.keys(newCloneObj))
// >> []
for (var p in newCloneObj) console.log(p)
// >> protoPropHi
